...
namespace test
{
    ...
    {
        public int ExamTimeInMinutes { get; set; } // Added property for exam time
        public QuestionType QuestionType { get; set; } // Added property for question type

        // Method to create True/False question
        ...
        public void AddQuestions()
        {
            ...
            for (int i = 0; i < NumberOfQuestions; i++)
            {
                ...
                // Assuming you have a QuestionType enum, you can select it based on the type of question you want to add
                // Here, we'll add both True/False and Multiple Choice questions for demonstration
        ...
        // Modify the ShowExam method in the FinalExam class
